...
//     TEST_ASSERT_MESSAGE("farm" == hashmap_getValue(myHashmap, "pig"));
//     hashmap_update(myHashmap,"pig","cool");
//     TEST_ASSERT_MESSAGE("cool" == hashmap_getValue(myHashmap, "pig"));
//     hashmap_removeKey(myHashmap,"pig");
//     TEST_ASSERT_MESSAGE(0 == hashmap_hasKey(myHashmap, "pig"));
