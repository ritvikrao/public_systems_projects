...
Michaelangelo, Picasso, Monet, Kahlo, Cassatt, all legendary artists of their time. For this in-class lab, you are going to utilize these great artists to create a masterpiece, or rather--help a bunch of competitive artists work on a masterpiece together.
...
# Part 1 - Painting with multiple Processes

## Logistics

For part one you will be working in the [vfork.c](./vfork.c) file.Our artists prefer to paint in Unix, so again I recommend you work from your virtual box installation. 
...
*Each of the 30+ machines have 12 cores available.* 
...
### Task 3 - Synchronization with fork()
...
3. Answer the discussion questions and edit this [README.md](./README.md)
