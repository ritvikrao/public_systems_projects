...
#include "binary.h"
#include <string.h>
//#include <ncurses.h> // Not currently supported on login.khoury.neu.edu machines.

// Toggle these values to generate different
// addresses
#define BITWIDTH 8	// Our 'fictional' architecture is an 8-bit architecture. 
			// 	i.e. contains M= 2^m where m is BITWIDTH unique addresses.
#define ADDRESSES 1024	// By default we generate 1024 instructions
#define RANGE 256	// The range of these instructions is a value 0-256. 
			// 	i.e. Coincides with 'M' our BITWIDTH
