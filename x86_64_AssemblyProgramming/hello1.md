...
In this tutorial you will print out a message and then exit.

Learnings
1. .global and _start (the true entry point of a program)
2. .text
3. syscall (write and exit)
4. Saving our stack pointer (in rbp)when we move into a function
5. popq
...
**Note**: The program works, but there is 1 tiny bug we will fix in the next tutorial
